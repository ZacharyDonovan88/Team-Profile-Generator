const manager = managerData => {
    ...
    <div id="${managerData.getRole()}-card" class="box card">
      <div class="box name-role manager-name">
        ...
        <h3>Role: ${managerData.getRole()} <span class="material-symbols-outlined">
        local_cafe
        </span></h3>
      </div> 
      <div class="box employee-info">
        <ul class="list-group">
          ...
          <li class="list-group-item">Email: <a href="mail to:${managerData.getEmail()}">${managerData.getEmail()}</a></li>
  ...
  const engineer = engineerData => {
    ...
    <div id="${engineerData.getRole()}-card" class="box card">
      <div class="box name-role engineer-name">
        ...
        <h3>Role: ${engineerData.getRole()} <span class="material-symbols-outlined">
        build
        </span></h3>
      </div> 
      <div class="box employee-info">
        <ul class="list-group">
          ...
          <li class="list-group-item">Email: <a href="mail to:${engineerData.getEmail()}">${engineerData.getEmail()}</a></li>
  ...
  const intern = internData => {
    ...
    <div id="${internData.getRole()}-card" class="box card">
      <div class="box name-role intern-name">
        ...
        <h3>Role: ${internData.getRole()} <span class="material-symbols-outlined">
        person
        </span></h3>
      </div> 
      <div class="box employee-info">
        <ul class="list-group">
          ...
          <li class="list-group-item">Email: <a href="mail to:${internData.getEmail()}">${internData.getEmail()}</a></li>
